...
updated on 2019/05/03 for large scale testing. 
...
def F_download_filelist(filelist,ret,savepath=''):
    ...
    filelist:
        a list of online file names, like ['3HRLY/2015/NARRsfc_201507_0109.tar']
    ret:
...
def F_untar_filelist(filelist,savepath='',if_delete_tar=False):
    ...
    filelist:
        a list of tar file names generated by F_generate_filelist, like 
        ['3HRLY/2015/NARRsfc_201507_0109.tar']
    savepath:
        path to save extracted grib files
...
def F_subset_grib_to_mat(grib_dir='',mat_dir='',\
    ...
    mat_path:
        path to save extracted .mat files. mat files will be saved at 
        mat_path/yyyy/mm/subset_*_dd_HH.mat, where * can be sfc, 3D, ...
